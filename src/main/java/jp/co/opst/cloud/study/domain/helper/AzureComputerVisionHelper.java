...
public class AzureComputerVisionHelper {
    ...
    private final String GENERATE_THUMBNAIL_URL = "https://api.projectoxford.ai/vision/v1.0/generateThumbnail";

    public InputStream createThumbnail(String sourceImgUrl) {
